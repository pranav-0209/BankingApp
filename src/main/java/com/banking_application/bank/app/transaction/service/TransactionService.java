...
import com.banking_application.bank.app.exception.AccountNotFoundException;
import com.banking_application.bank.app.exception.InsufficientFundsException;
...
public class TransactionService {
    ...
    public TransactionResponseDTO deposit(String username, TransactionRequestDTO dto) {
        ...
        if (account == null) {
            throw new AccountNotFoundException("Account not found with number: " + dto.getAccount());
        }
    ...
    public TransactionResponseDTO transfer(String username, TransactionRequestDTO requestDTO) {
        ...
        if (fromAccount == null) {
            throw new AccountNotFoundException("Account not found with number: " + requestDTO.getAccount());
        }
